...
class GAN(object):
    ...
    def discriminator(self):
        ...
        x = d_block(inp, 1 * cha)   #256

        x = d_block(x, 2 * cha)   #128

        x = d_block(x, 4 * cha)   #64

        x = d_block(x, 8 * cha)  #32

        x = d_block(x, 16 * cha)  #16

        x = d_block(x, 32 * cha, p = False)  #8
    ...
    def generator(self):
        ...
        x, r = g_block(x, inp_style[1], inp_noise, 16 * cha)  #16
        outs.append(r)

        x, r = g_block(x, inp_style[2], inp_noise, 8 * cha)  #32
        outs.append(r)

        #x, r = g_block(x, inp_style[3], inp_noise, 6 * cha)  #64
        #outs.append(r)
...
class StyleGAN(object):
    ...
    def __init__(self,directory, steps = 1, lr = 0.0001, decay = 0.00001, silent = True):
...
#
# data_dirs = [
#     r'C:\Users\lemon\Desktop\FL-GAN_COVID-main\8GAN\Kvasir\dyed-lifted-polyps',
#     r'C:\Users\lemon\Desktop\FL-GAN_COVID-main\8GAN\Kvasir\dyed-resection-margins',
#     r'C:\Users\lemon\Desktop\FL-GAN_COVID-main\8GAN\Kvasir\esophagitis',
#     r'C:\Users\lemon\Desktop\FL-GAN_COVID-main\8GAN\Kvasir\normal-cecum',
#     r'C:\Users\lemon\Desktop\FL-GAN_COVID-main\8GAN\Kvasir\normal-pylorus',
#     r'C:\Users\lemon\Desktop\FL-GAN_COVID-main\8GAN\Kvasir\normal-z-line',
#     r'C:\Users\lemon\Desktop\FL-GAN_COVID-main\8GAN\Kvasir\polyps',
#     r'C:\Users\lemon\Desktop\FL-GAN_COVID-main\8GAN\Kvasir\ulcerative-colitis',
# ]
#
# class_names = [
#     'dyed-lifted-polyps',
...
#
# for class_index, data_dir in enumerate(data_dirs):
#
#     classname = class_names[class_index]
#
#     model = StyleGAN(directory, lr = 0.0001, silent = False)
#     model.GAN.steps = 1
#
#     while model.GAN.steps < 1000001:
#         model.train()
#
directory = r'C:\Users\lemon\Desktop\FL-GAN_COVID-main\8GAN\Kvasir\dyed-lifted-polyps'
